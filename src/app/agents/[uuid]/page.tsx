    ...
    return (
        <main className="w-full h-full 2xl:h-full max-w-screen 2xl:max-h-screen bg-center bg-cover bg-[url('/background-haven.png')] 2xl:overflow-hidden">
            <div className="w-full max-h-screen overflow-y-auto relative 2xl:static">
                ...
                <div className="hidden 2xl:block fixed top-0 left-0 w-fit h-screen overflow-hidden animate-flowDown">
                ...
                <div className="hidden 2xl:block fixed top-0 right-0 w-fit h-screen overflow-hidden animate-flowUp">
                ...
                <div className="flex flex-col w-full overflow-hidden">
                    ...
                    <div className="px-6 2xl:px-0 mt-6 mb-4 2xl:mt-0 2xl:mb-0 order-4 bottom-1/2 space-y-2 2xl:translate-y-1/2 2xl:absolute z-40 right-10 w-full max-w-full 2xl:w-[40rem] flex flex-col items-end">
                        <div className="animate-abilityFlow animate-duration-[0.5s]">
                            <AbilityBox
                        ...
                        <div className="animate-abilityFlow animate-duration-[1s]">
                            <AbilityBox
                        ...
                        <div className="animate-abilityFlow animate-duration-[1.5s]">
                            <AbilityBox
                        ...
                        <div className="animate-abilityFlow animate-duration-[2s]">
                            <AbilityBox
